...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'http://34.198.205.91:8080';
const API_BASE_URL_ROUTING =  process.env.NEXT_PUBLIC_API_URL || 'https://master.d2hh6o27ll1srl.amplifyapp.com/';
